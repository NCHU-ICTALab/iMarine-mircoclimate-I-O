...
| --- | ---: | ---: | ---: | ---: | ---: |
| H1 | 0.5919 | 1.6457 | 0.3698 | -0.0579 | 0 |
| H2 | 0.5920 | 1.6458 | 0.3697 | -0.0579 | 0 |
| H3 | 0.7156 | 1.6933 | 0.3329 | -0.1013 | 0 |
| H4 | 0.7156 | 1.6934 | 0.3329 | -0.1012 | 0 |

判讀：短期 H1/H2 的平均誤差約 0.59 m/s，H3/H4 約 0.72 m/s。R2 約 0.33 到 0.37，代表可提供派工參考，但不是高精度風速數值預報。
...
| 預測錨點 | MAE | RMSE | R2 | Bias | critical under-warning |
| --- | ---: | ---: | ---: | ---: | ---: |
| H1 | 0.6835 | 0.9632 | 0.8519 | 0.0692 | 0 |
| H2 | 0.6835 | 0.9632 | 0.8519 | 0.0691 | 0 |
| H3 | 0.9458 | 1.3301 | 0.7175 | 0.0126 | 0 |
| H4 | 0.9458 | 1.3302 | 0.7175 | 0.0125 | 0 |

判讀：陣風表現比平均風速穩定，H1/H2 的 R2 約 0.85，H3/H4 約 0.72；目前沒有重大低估警示案例，適合做派工風險參考。
...
| --- | ---: | ---: | ---: | ---: | ---: |
| H1 | 0.0183 | 0.6187 | 0.1810 | 0.9638 | 0.5443 |
| H2 | 0.0183 | 0.6187 | 0.1810 | 0.9638 | 0.5443 |
| H3 | 0.0261 | 0.3705 | 0.2536 | 0.9274 | 0.3291 |
| H4 | 0.0261 | 0.3705 | 0.2536 | 0.9274 | 0.3291 |

判讀：H1/H2 的降雨機率表現較佳，AUC 約 0.96，Brier score 約 0.018。H3/H4 仍可用，但 POD 和 CSI 明顯下降，因此較適合作為風險提醒，不建議單獨用來做硬性派工取消決策。
